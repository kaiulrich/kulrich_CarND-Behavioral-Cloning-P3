...
history_object = model.fit_generator(gen_train,
                    ...
                    epochs=nb_epoch,
                    callbacks=[
				   keras.callbacks.ModelCheckpoint(model_dir + '/model.' + date_string + '.{epoch:02d}-{val_loss:.2f}.h5', monitor='val_loss', verbose=0, save_best_only=False, save_weights_only=False, mode='auto', period=1),
